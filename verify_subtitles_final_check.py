...
if __name__ == "__main__":
    # Test for S01E01 (Final Final Result)
    srt_path = "/Users/umutimamoglu/sublex/subtitles/The.Boys.S01E01.srt"
    db_path = "/Users/umutimamoglu/sublex/backend/the_boys_s1e1_db_words_final.txt"
    ...
    print(f"DB unique words (Fresh S01E01): {len(db_words)}")
