...
if __name__ == "__main__":
    srt_path = "/Users/umutimamoglu/sublex/subtitles/Arcane. S01E01. Welcome. to. the. Playground. 1080p. NF. WEB-DL. DDP5. 1. H. 264-TEPES.srt"
    db_path = "arcane_s1e1_db_words.csv"
    ...
    if not only_srt and not only_db and not mismatches:
        ...
        print(f"\nResult: {len(only_srt)} only in SRT, {len(only_db)} only in DB.")
