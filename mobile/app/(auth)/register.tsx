      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
        <View className="flex-1 justify-center px-6 py-12">
          ...
          <View className="items-center mb-10">
            ...
            <Text className="text-gray-500 dark:text-gray-400 mt-1">Hemen ücretsiz hesabını oluştur</Text>
          </View>

          {/* Form */}
          <View className="bg-white dark:bg-[#161822] rounded-2xl border border-gray-200 dark:border-gray-800 p-6">
            <Text className="text-xl font-bold text-gray-900 dark:text-white mb-6">Kayıt Ol</Text>
            ...
            <Text className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Adın</Text>
            <TextInput
              value={name}
            ...
            >
              {loading ? (
                ...
                <Text className="text-white font-bold text-base">Hesap Oluştur</Text>
              )}
            </TouchableOpacity>

            <View className="flex-row justify-center mt-6">
              <Text className="text-gray-500 dark:text-gray-400 text-sm">Zaten hesabın var mı? </Text>
              <Link href="/(auth)/login" className="text-indigo-600 dark:text-indigo-400 text-sm font-medium">
                Giriş Yap
              </Link>
            </View>
          </View>
